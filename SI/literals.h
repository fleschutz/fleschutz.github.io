...
// force (F) in...
LITERAL(_ZN,    1e21, newtons);             // 1_ZN (zettanewton)
LITERAL(_EN,    1e18, newtons);             // 1_EN (exanewton)
LITERAL(_PN,    1e15, newtons);             // 1_PN (petanewton)
LITERAL(_TN,    1e12, newtons);             // 1_TN (teranewton)
...
LITERAL(_klx,    1e3, lux);                 // 1_klx (kilolux)
LITERAL(_lx,       1, lux);                 // 1_lx  (lux)
LITERAL(_mlx,   1e-3, lux);                 // 1_mlx (millilux)
LITERAL(_ulx,   1e-6, lux);                 // 1_ulx (microlux)
LITERAL(_plx,   1e-9, lux);                 // 1_plx (picolux)
